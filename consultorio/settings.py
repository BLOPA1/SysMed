...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Asegúrate de que está configurado
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LANGUAGE_CODE = 'es'  # Cambiar de 'en-us' a 'es' para español

TIME_ZONE = 'America/Argentina/Buenos_Aires'  # Cambia según tu zona horaria
